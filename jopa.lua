...
local TG_MAIN = {
    ...
    Enabled = true,
    ImportantObjects = {
        ["Sedasdsacret Lucky Block"] = true,
        ["Pot Hotdsadasspot"] = true,
        ...
        ["Ketupat Kepat"] = true,
        ["Noddoo My Hotddspot"] = true,
        ["Spaghetti Tualetti"] = true,
        ["Strawberry Elephant"] = true,
        ["Ketchuru and Musturu"] = true,
        ["Lddos Noddoo My Hotspddotsitos"] = true,
